...
public class S_SubMenu : MonoBehaviour
{
    ...
    static float f_Target_Line = -1.5f; // Default Value

    // Variables - Activations
    static float f_ActivationInterval;
